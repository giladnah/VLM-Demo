...
@pytest.fixture
def mock_large_inference_output() -> MagicMock:
    """Provides a mock large inference output with result and detailed_analysis fields."""
    return MagicMock(result="yes", detailed_analysis="This frame contained elements that met the trigger.")
